...
1.  User story: I can see different button types: default, outline and text
2.  User story: I can choose to disable box-shadow
...
[**Go to demo**](https://64dc8c378d1c331facc35f31-qoapnjakzy.chromatic.com/?path=/docs/button--docs)
